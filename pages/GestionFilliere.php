      ...
      <div class="col-md-12">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <td> 
              <a type="button" class="btn btn-primary btn-sm mr-2" href="editfil.php?id=<?php echo($fil['id_filiere']) ?>" >Modifier</a>
              <a type="button" class="btn btn-danger btn-sm" href="deletefil.php?id=<?php echo($fil['id_filiere']) ?>" >Supprimer</a>
              </td>
            </tr> 
            <?php }?>
          </tbody>
        ...
        <div class="text-right mt-3">
          <a type="button" class="btn btn-success" href="addfiliereform.php">Ajouter une filière</a>
        </div>
      </div>
    </div>
